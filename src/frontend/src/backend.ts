...
import type { AttMonth as _AttMonth, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addStaff(arg0: string, arg1: string, arg2: string, arg3: number, arg4: number, arg5: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async finalizeSalary(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.finalizeSalary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAttMonth(arg0: string): Promise<AttMonth | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAttMonth(arg0);
    ...
    async getNetPay(arg0: string): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getNetPay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStaff(arg0: bigint, arg1: bigint): Promise<Array<Staff>> {
        if (this.processError) {
            try {
    ...
    async saveAttMonth(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: bigint, arg5: bigint, arg6: bigint, arg7: bigint, arg8: bigint, arg9: number, arg10: number, arg11: number, arg12: number, arg13: number, arg14: number, arg15: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAttMonth(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AttMonth]): AttMonth | null {
